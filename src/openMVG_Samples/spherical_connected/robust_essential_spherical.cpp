...
int main(int argc, char **argv) {
  ...
  int resize_h, resize_w = 0;

  cmd.add( make_option('a', jpg_filenameL, "input_a") );
  cmd.add( make_option('b', jpg_filenameR, "input_b") );

  // cmd.add( make_option('h', resize_h, "resize_h") );
  // cmd.add( make_option('w', resize_w, "resize_w") );
  ...
  // Essential geometry filtering of putative matches
  {
    ...
    //-- Essential matrix robust estimation from spherical bearing vectors
    {
      ...
      // if (vec_inliers.size() > 20) // 60 is used to filter solution with few common geometric matches (unstable solution)
      // {
      ...
      //                                 &inliers_X))
      //   {
      //     // std::cout << "\n asMatrix:" <<  relative_pose.asMatrix() << std::endl;
      //     // std::cout << "\n rotation:" << relative_pose.rotation() << std::endl;
      //     // std::cout << "\n center:" << relative_pose.center() << std::endl;
      //     // std::cout << "\n translation:" << relative_pose.translation() <<std::endl;
      //     const Vec3 center = relative_pose.center();
      //     const Vec2 hostpot = cameraL.project(relative_pose.center());
      //     geometry::Pose3 inverse_pose = relative_pose.inverse();
      //     const Vec2 inverse_hostpot = cameraR.project(inverse_pose.center());

      //     std::cout << "\n(x, y) = (" << hostpot.x() << "," << hostpot.y() << ")" << std::endl;
      //     std::cout << "\n(x, y) = (" << inverse_hostpot.x() << "," << inverse_hostpot.y() << ")"<< std::endl;
      ...
      //     // tiny_scene.poses[tiny_scene.views[0]->id_pose] = relative_pose.inverse();
      //     // tiny_scene.poses[tiny_scene.views[1]->id_pose] = relative_pose;
      ...
      //     // if (Save(tiny_scene, "EssentialGeometry_start.json", ESfM_Data(ALL)) == false){
      //     //   return 1;
      //     // }
